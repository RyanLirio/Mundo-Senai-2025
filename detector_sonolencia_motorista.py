...
class DetectorSonolencia:
    def __init__(self, porta_serial='COM4', ear_limiar=0.12):
        ...
        self.TEMPO_ALERTA = 2.0      # Alerta após 2 segundos
        self.TEMPO_PERIGO = 4.0      # Perigo após 4 segundos - LED vai piscar
        self.TEMPO_ESTATICO_MAX = 3.0  # Máximo tempo com olhos estáticos
        self.LIMIAR_VARIACAO_EAR = 0.02  # Limiar para considerar mudança no EAR
        self.MAX_PISCADAS_INTERVALO = 5  # Máximo de piscadas em 3 segundos
        self.INTERVALO_ANALISE_PISCADAS = 3.0  # Intervalo para análise de piscadas
    ...
    def _emitir_alerta(self, frame, nivel_alerta):
        if nivel_alerta > 0:
            ...
            if self.tempo_olhos_fechados > 0:
                ...
                info_texto = f"Olhos estáticos: {self.tempo_olhos_estaticos:.1f}s"
            else:
    ...
    def processar_frame(self, frame):
        ...
        for face_landmarks in resultado.multi_face_landmarks:
            ...
            # Desenha pontos dos olhos para referência
